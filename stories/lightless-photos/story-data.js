window.STORY = {
  ...
  scenes: {
    ...
    b11: bridge("2부 계획 전환", "문턱에서", [
      ...
      intro: variants([
        condition(["plannedCheckIn"], "“돌아올 시간을 적는 것만으로는 부족해.” 여진이 통화 너머에서 말했다. “네가 늦으면 내가 무엇을 해야 하는지도 말해 줘.” 서린은 한동안 대답하지 못하다가 신고할 시각과 연락할 사람의 이름을 차례로 읽었다. 여진은 그 목록을 받아 적은 뒤 마지막으로 물었다. “내가 지금 멈추라고 하면?” 그 질문은 계획표 어디에도 없었다."),
      ]),
      choices: [
